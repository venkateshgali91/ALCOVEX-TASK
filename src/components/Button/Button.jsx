          ...
          {state.type === "loader" && (
            <div
              className={`w-[12px] bg-[100%_100%] h-[11.97px] relative ${
                state.size === "large"
                  ? "bg-[url(/img/ellipse-1-1.svg)]"
                  : state.size === "small"
                  ? "bg-[url(/img/ellipse-1.svg)]"
                  : "bg-[url(/img/ellipse-1-2.svg)]"
              }`}
            />
          )}
        </div>
...
Button.propTypes = {
  iconLeftInstance: PropTypes.bool,
  icon: PropTypes.bool,
  iconRight: PropTypes.bool,
  size: PropTypes.oneOf(["large", "regular", "small"]),
  stateProp: PropTypes.oneOf(["hover", "active", "default"]),
  type: PropTypes.oneOf(["success", "secondary", "primary", "icon-secondary", "error", "icon-button", "loader"]),
